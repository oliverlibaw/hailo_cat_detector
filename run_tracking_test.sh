...
echo ""
echo "NEW: Ultra-Precise 7-Zone Tracking System"
echo " - Extreme Left Zone: Moves right for 0.15 seconds"
echo " - Far Left Zone: Moves right for 0.10 seconds"
echo " - Near Left Zone: Moves right for 0.05 seconds (micro-adjustment)"
echo " - Center Zone: No movement (±15% of frame width)"
echo " - Near Right Zone: Moves left for 0.05 seconds (micro-adjustment)"
echo " - Far Right Zone: Moves left for 0.10 seconds"
echo " - Extreme Right Zone: Moves left for 0.15 seconds"
echo ""
echo "Advanced Anti-Overshoot Features:"
echo " - Micro-adjustments (0.05s) for fine-tuning near center"
echo " - Automatic duration reduction for consecutive movements"
echo " - Movement limiting after 3 consecutive moves in same direction"
echo " - Reduced movement cooldown for faster response (0.3s)"
echo " - Smaller center zone (±15%) for more precise centering"
echo " - Adaptive cooldown that increases after oscillation detected"
echo " - Visual movement tracking with consecutive movement counter"
echo ""
